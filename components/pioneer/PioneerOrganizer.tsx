...
export default function PioneerOrganizer({ initialMode }: { initialMode: Mode }) {
    ...
    return <main className="min-h-screen bg-slate-50 px-4 py-5 dark:bg-slate-950"><div className="mx-auto max-w-md">
        ...
        {initialMode !== 'calendar' && <div className="mb-5 grid grid-cols-2 rounded-2xl bg-slate-200 p-1 dark:bg-slate-800"><Tab active={mode === 'studies'} onClick={() => setMode('studies')}>Estudos</Tab><Tab active={mode === 'revisits'} onClick={() => setMode('revisits')}>Revisitas</Tab></div>}
