            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              {zoomMeetingUrl && (
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-2 text-sm font-bold text-white shadow-sm transition hover:bg-[#1fb855] hover:shadow-md focus:outline-none focus:ring-4 focus:ring-green-300 dark:focus:ring-green-800"
                >
                  <svg aria-hidden="true" viewBox="0 0 24 24" className="h-4 w-4 fill-current">
