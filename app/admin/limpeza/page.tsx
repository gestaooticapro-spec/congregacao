    ...
    return (
        <div className="w-full min-w-0 pb-24 print:max-w-none print:p-0">
            <PageHeader
                ...
                actions={
                    <div className="w-full flex flex-col sm:flex-row items-center justify-center gap-3 sm:w-auto sm:gap-4">
                        <div className="flex items-center gap-3 bg-white dark:bg-slate-900 p-1.5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
                            <button type="button" onClick={() => handleBimesterChange('prev')} className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors text-primary font-bold" title="Bimestre Anterior">◀</button>
                            <div className="text-center min-w-[180px]">
                                <span className="block font-bold text-base text-slate-900 dark:text-white">{getBimesterName(currentBimester)}</span>
                                <span className="text-xs font-semibold text-primary uppercase tracking-widest">{currentYear}</span>
                            </div>
                            <button type="button" onClick={() => handleBimesterChange('next')} className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors text-primary font-bold" title="Próximo Bimestre">▶</button>
                        </div>
                        <button type="button" onClick={handlePrint} className="w-full sm:w-auto px-4 sm:px-6 py-2.5 bg-slate-800 text-white rounded-xl font-bold hover:bg-slate-700 transition-all shadow-lg shadow-slate-200 dark:shadow-none flex items-center justify-center gap-2">
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 002 2v4m8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
                            </svg>
                            Imprimir Escala
                        </button>
                    </div>
